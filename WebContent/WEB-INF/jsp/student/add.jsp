...
<body>
  <div class="container">
    ...
    <div class="span11" style=" border: solid; border-color: #DDDDDD;">
      ...
      <!-- <div class="span9 margin-top-two">
>>>>>>> 624d41a667a6303c51b8191854bb2b3e52792412
      <fieldset>
        <legend>标准房设置</legend>
      </fieldset>
    </div> -->
    ...
    <form action="${ctx}/Student/toaddStudent.do" method="post"><!--  onsubmit="return verify()"> -->
      ...
      <form action="${ctx}/Student/toaddStudent.do" method="post" onsubmit="return verify()">
        <div class="span12 margin-top-two">
          <div class="row-fluid">
            <div class="span5">
              ...
              <!-- <input id="userId" name="userId" class="textone inputone"
			       style="height:26px;" type="text" onblur="YZ(this.value)" onchange="onchangeOne()"> -->
              <input id="userId" name="userId" class="textone inputone" style="height:26px;" type="text"
            ...
            <div class="span5">
              <label class="labelroomnumber marginrighttwo">姓名：</label>
              <input id="userName" name="userName" class="textone inputone" style="height:26px;" type="text"
                onchange="onchangeOne()"><!-- onblur="YZ(this.value)" -->
              <div id="divOne">
                <label class="yansered" style="margin-top:18px;">*</label>
              </div>
            </div>
	    ...
	    <!-- <div class="span12 margin-top-one">
            ...
            <div class="span5">
              <label class="labelroomnumber marginrighttwo">注册日期</label>
              <input id="signTime" name="signTime" class="textone inputone" style="height:26px;" type="date"
                onblur="onchangeOne()">
            </div>
            <div class="span5">
              <label class="labelroomnumber">科目：</label>
     ...
     //     cache:false,                                             //是否使用缓存提交 如果为TRUE 会调用浏览器的缓存 而不会提交
       ...
       //       if(result>=1){                                  
        ...
        <div class="span6" style="text-align:center;">
          <div class="row-fluid" style="float:left;">
            <div class="span12" style="margin-top: 10px;margin-bottom: 8px;">
              <button class="btn btn-primary" type="submit">
                <li class="icon-check icon-white"></li>保存
              </button>
            </div>
      ...
      <div class="span4" style="text-align:center;">
        <div class="row-fluid">
          <div class="span4" style="margin-top: 10px;margin-bottom: 8px;">
            <button class="btn btn-warning" type="button" onclick="deletefunction()">
              <li class="icon-remove icon-white"></li>取消
            </button>
          </div>
        </div>
      </div>
